...
export default function ModalAbout({modalHandler}) {
    ...
    return (
        <div className="modal about">
            ...
            <p>This Sudoku web application was created by Jérome Boisvert-Chouinard
            based on the open source code for <a href="https://sudokuexchange.com/"
            ...
            <a href="https://github.com/grantm/sudoku-web-app">https://github.com/jbchouinard/sudoku-web-app</a>.</p>
            <p>
            Copyright © 2020 Jérome Boisvert-Chouinard
            Copyright © 2020 Grant McLean
            </p>
